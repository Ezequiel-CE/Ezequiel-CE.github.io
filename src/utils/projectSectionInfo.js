...
export const projectsEng = [
  ...
  },
  {
    ...
    description:
      "My personal website,build with Reactjs,React Bootstrap and use redux to handle the state of the page.",
    img: portafolio,
    done: true,
  },
  {
  ...
  {
    title: "Contact CRUD",
    link: "https://github.com/Ezequiel-CE/contact-CRUD-front",
    description:
